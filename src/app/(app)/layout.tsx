...
import {
  ...
  Ruler, Zap, Share2, ClipboardList, Truck, Activity, LifeBuoy, Gauge, Filter, Megaphone,
} from "lucide-react";
...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/campanhas", label: "Campanhas WhatsApp", Icon: Megaphone, needs: "use_whatsapp" },
